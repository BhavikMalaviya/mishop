...
class FirstRatingScreen extends StatefulWidget {
  @override
  _FirstRatingScreenState createState() => _FirstRatingScreenState();
}

class _FirstRatingScreenState extends State<FirstRatingScreen> {
  List<Sentence> _sentences = <Sentence>[
    Sentence(1, 'This company provided little to no value.', false),
    Sentence(2, 'This company did not provide the value we expected.', true),
    Sentence(3, 'This company met my expectation for the value they delivered.',
        false),
    Sentence(4, 'This company provided very good value for the money I spent.',
        false),
    Sentence(
        5,
        'This company provided on amazing value that exceeded my expectations.',
        false),
  ];
