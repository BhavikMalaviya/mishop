...
import 'package:micatalogs/modal/Catalog.dart';
...
class _CategoryProductListScreenState
  ...
  int index = 1;
  Future<void> getCategory(int index) async {
    http
        .get("http://api.aeonarc.in/api/v1/category?page=${index}",
